...
using ParticleDataTypes = Cabana::MemberTypes<double[3], // position(0)
					      int, // ids(1)
					      double[3], // velocity(2)
					      double[3], // force (3)
					      double, // mass(4)
...
/*
  Declare the wall type
*/
using WallDataTypes = Cabana::MemberTypes<double[3], // position(0)
					  int, // ids(1)
					  double[3], // velocity(2)
					  double[3], // force (3)
					  double, // mass(4)
...
using AoSoAParticleType = Cabana::AoSoA<ParticleDataTypes, DeviceType, VectorLength>;
using AoSoAWallType = Cabana::AoSoA<WallDataTypes, DeviceType, VectorLength>;
...
void dem_stage_1(AoSoAParticleType& aosoa, double dt, int * limits){
  auto aosoa_position = Cabana::slice<0>     ( aosoa,    "position");
  auto aosoa_ids = Cabana::slice<1>          ( aosoa,    "ids");
  auto aosoa_velocity = Cabana::slice<2>     ( aosoa,    "velocity");
  auto aosoa_force = Cabana::slice<3>          ( aosoa,    "force");
...
void dem_stage_2(AoSoAParticleType& aosoa, double dt, int * limits){
  auto aosoa_position = Cabana::slice<0>     ( aosoa,    "position");
  auto aosoa_ids = Cabana::slice<1>          ( aosoa,    "ids");
  auto aosoa_velocity = Cabana::slice<2>     ( aosoa,    "velocity");
  auto aosoa_force = Cabana::slice<3>          ( aosoa,    "force");
...
void dem_stage_3(AoSoAParticleType& aosoa, double dt, int * limits){
  auto aosoa_position = Cabana::slice<0>     ( aosoa,    "position");
  auto aosoa_ids = Cabana::slice<1>          ( aosoa,    "ids");
  auto aosoa_velocity = Cabana::slice<2>     ( aosoa,    "velocity");
  auto aosoa_force = Cabana::slice<3>          ( aosoa,    "force");
...
void SWHertzContactForce(AoSoAParticleType &aosoa_particles,
			 AoSoAWallType &aosoa_wall,
			 ViewVectorType & kn,
			 double dt,
			 ListType * verlet_list,
			 int * limits){
  auto aosoa_particles_position = Cabana::slice<0>     ( aosoa_particles,    "position");
  auto aosoa_particles_ids = Cabana::slice<1>          ( aosoa_particles,    "ids");
  auto aosoa_particles_velocity = Cabana::slice<2>     ( aosoa_particles,    "velocity");
  auto aosoa_particles_force = Cabana::slice<3>          ( aosoa_particles,    "force");
  auto aosoa_particles_mass = Cabana::slice<4>        ( aosoa_particles,    "mass");
  auto aosoa_particles_density = Cabana::slice<5>        ( aosoa_particles,    "density");
  auto aosoa_particles_radius = Cabana::slice<6>     ( aosoa_particles,    "radius");
  auto aosoa_particles_E = Cabana::slice<7>     ( aosoa_particles,    "E");
  auto aosoa_particles_nu = Cabana::slice<8>     ( aosoa_particles,    "nu");
  auto aosoa_particles_G = Cabana::slice<9>     ( aosoa_particles,    "G");
  auto aosoa_particles_omega = Cabana::slice<10>     ( aosoa_particles,    "omega");
  auto aosoa_particles_torque = Cabana::slice<11>          ( aosoa_particles,    "torque");

  auto aosoa_wall_position = Cabana::slice<0>     ( aosoa_wall,    "position");
  auto aosoa_wall_ids = Cabana::slice<1>          ( aosoa_wall,    "ids");
  auto aosoa_wall_velocity = Cabana::slice<2>     ( aosoa_wall,    "velocity");
  auto aosoa_wall_force = Cabana::slice<3>          ( aosoa_wall,    "force");
  auto aosoa_wall_mass = Cabana::slice<4>        ( aosoa_wall,    "mass");
  auto aosoa_wall_density = Cabana::slice<5>        ( aosoa_wall,    "density");
  auto aosoa_wall_radius = Cabana::slice<6>     ( aosoa_wall,    "radius");
  auto aosoa_wall_E = Cabana::slice<7>     ( aosoa_wall,    "E");
  auto aosoa_wall_nu = Cabana::slice<8>     ( aosoa_wall,    "nu");
  auto aosoa_wall_G = Cabana::slice<9>     ( aosoa_wall,    "G");
  auto aosoa_wall_omega = Cabana::slice<10>     ( aosoa_wall,    "omega");
  auto aosoa_wall_torque = Cabana::slice<11>          ( aosoa_wall,    "torque");
  auto aosoa_wall_normal = Cabana::slice<12>          ( aosoa_wall,    "normal");

  Cabana::deep_copy( aosoa_force, 0. );
  Cabana::deep_copy( aosoa_torque, 0. );

  double no_of_walls = aosoa_wall_position.size();

  auto sw_hertz_lambda_func = KOKKOS_LAMBDA( const int i )
    {
      double inv_mass_i = 1. / aosoa_mass( i );
      double tmp = inv_mass_i * half_dt;
      aosoa_velocity(i, 0) += aosoa_force( i, 0 ) * tmp;
  ...
  Kokkos::RangePolicy<ExecutionSpace> policy( limits[0], limits[1] );
  Kokkos::parallel_for( "CabanaSPH:Integrator:SWHertzForce", policy,
			sw_hertz_lambda_func );
}


void output_data(AoSoAParticleType& aosoa, int num_particles, int step, double time)
{
...
void run()
{
  ...
  */
  ...
  /*
    ...
    ================================================
  */
  AoSoAParticleType aosoa( "particles", total_no_particles );
